...
export const PROJECTS: Project[] = [
  { slug: "haunting-london", client: "1D", title: "10 Years of One Direction", tags: ["Experience", "Website", "Campaign"], year: "2018", palette: ["#e7e3da", "#9aa0b5"], art: "grid" },
  { slug: "superdry-aw23", client: "Superdry®", title: "Puffer AW23", tags: ["Communication", "Campaign", "Brand"], year: "2023", palette: ["#ff5c2e", "#3a1206"], art: "orbs" },
  { slug: "google-maps", client: "Google", title: "Mountain View Visitor", tags: ["Product", "Website", "Tool"], year: "2020", palette: ["#4f8bff", "#0a1d4d"], art: "mesh" },
  { slug: "nandos-extra-hot", client: "Nando's", title: "Extra Hot Drop", tags: ["Communication", "Campaign", "Social"], year: "2022", palette: ["#19a36b", "#08361f"], art: "split" },
  { slug: "data-ai-trends", client: "Studio", title: "Data & AI Trends", tags: ["Experience", "Motion", "Website"], year: "2024", palette: ["#2b3a67", "#070b18"], art: "wave" },
  { slug: "monumental-beanies", client: "Beavertown", title: "Monumental Beanies", tags: ["Communication", "Content", "Campaign"], year: "2023", palette: ["#86b8e8", "#123a5e"], art: "duotone" },
  { slug: "diageo-blue", client: "Diageo", title: "Crafted For Dad", tags: ["Experience", "OOH", "Physical"], year: "2025", palette: ["#1450c8", "#04113a"], art: "mesh" },
  { slug: "inessa-biocyte", client: "Inessa", title: "Motion Identity", tags: ["Communication", "Brand", "Content"], year: "2022", palette: ["#efe9dc", "#b7ad94"], art: "split" },
  { slug: "free-spirits", client: "Octopus", title: "Free Spirits Center", tags: ["Experience", "Spatial", "Web"], year: "2021", palette: ["#c9ccd6", "#3a3f52"], art: "orbs" },
  { slug: "bridget-jones", client: "Working Title", title: "Bridget Jones OOH", tags: ["Communication", "Print", "Campaign"], year: "2024", palette: ["#d2452f", "#2a0a07"], art: "duotone" },
  { slug: "ai-compass", client: "FT", title: "AI Compass", tags: ["Product", "Editorial", "Tool"], year: "2025", palette: ["#ff9a3c", "#5a2a06"], art: "wave" },
  { slug: "diageo-aurora", client: "Diageo", title: "Aurora Launch", tags: ["Brand", "Motion", "3D"], year: "2025", palette: ["#0a2a6b", "#5cc8ff"], art: "mesh" },
  { slug: "footboo", client: "Footboo", title: "Match Day Drop", tags: ["Campaign", "Social", "Brand"], year: "2023", palette: ["#e23030", "#2a0606"], art: "split" },
  { slug: "nbc-universal", client: "NBCUniversal", title: "Next Stop", tags: ["Experience", "OOH", "Spatial"], year: "2024", palette: ["#b8492a", "#1a0b06"], art: "orbs" },
  { slug: "octopus-energy", client: "Octopus", title: "Smarter Tariffs", tags: ["Product", "Website", "Tool"], year: "2022", palette: ["#7b5cff", "#160a3a"], art: "grid" },
  { slug: "venus-studio", client: "Studio", title: "Venus Identity", tags: ["Brand", "3D", "Motion"], year: "2024", palette: ["#d8ff3e", "#1a2406"], art: "wave" },
];
